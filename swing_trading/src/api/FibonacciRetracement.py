...
#     levels = {
#         "100% (High)": highest_price,
#         "76.4%": highest_price - 0.236 * diff,
#         "61.8%": highest_price - 0.382 * diff,
#         "50.0%": highest_price - 0.5 * diff,
#         "38.2%": highest_price - 0.618 * diff,
#         "23.6%": highest_price - 0.764 * diff,
#         "0% (Low)": lowest_price,
#     }

#     # After calculating levels
#     stock_data['Date'] = stock_data['Date'].dt.strftime('%Y-%m-%d')  # Convert to string format

#   # ... (remaining code for attaching levels)
#     # Attach levels to stock_data (for demonstration)
#     stock_data = stock_data[['Date', 'Close']].copy()  # Ensure we only return Date and Close columns
#     stock_data['Fibonacci'] = None  # Placeholder for retracement levels

#     # return {"fibonacci_levels": levels, "stock_data": stock_data.to_dict(orient="records")}
#     return {"fibonacci_levels": levels, "stock_data": stock_data.to_dict(orient="records")}
